...
type AuditResponse = {
  ...
  operations?: {
    ...
    credits: { providerCycleUsed?: number | null; providerCycleLimit?: number | null; usedToday: number; estimatedProviderUsedToday?: number; dailyLimit: number; remainingToday: number | null };
    ...
    <div className="space-y-6">
      ...
      <section className="border-y border-slate-200 bg-white py-4">
        ...
        <div className="mt-4 grid gap-x-6 gap-y-3 sm:grid-cols-2 xl:grid-cols-4">
          ...
          <div>
            <div className="text-[11px] font-semibold uppercase text-slate-500">Provider cycle credits</div>
            <div className="mt-1 text-xl font-bold text-slate-900">
              {(operations.credits.providerCycleUsed ?? operations.credits.usedToday).toLocaleString()} / {(operations.credits.providerCycleLimit ?? operations.credits.dailyLimit).toLocaleString()}
            </div>
          </div>
          <div>
